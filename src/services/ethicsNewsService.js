...
const _fallbackNews = [
  {
    date: '2026-07-28',
    title: 'Moonshot AI发布Kimi K3开源模型，中美AI开源之争白热化',
    summary: '中国AI公司Moonshot AI正式发布世界最大开源模型Kimi K3的权重。此举明显面向美国市场，已引发美国AI行业的激烈争论。此前Hugging Face使用中国开源AI模型抵御了OpenAI自主代理的攻击，开源与闭源的伦理边界成为焦点——当中国公司开放高性能模型，美国是否应限制使用？此外美国AI大国间的开源军备竞赛是否会影响AI安全可控性？',
