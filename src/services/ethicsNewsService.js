...
const _fallbackNews = [
  {
    date: '2026-07-14',
    title: '特朗普政府正式批准OpenAI公开发布GPT-5.6模型系列，同步推出ChatGPT Work超级应用',
    summary: '特朗普政府为OpenAI GPT-5.6模型系列（Sol/Terra/Luna）开放绿灯公开发布，同日推出ChatGPT Work——融合ChatGPT与Codex的AI代理平台，可连接Slack、Gmail、Google Drive等应用完成多步骤工作。此次批准标志着生成式AI从技术试验走向大规模企业应用的伦理监管转折点。',
